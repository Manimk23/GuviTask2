...
//sendkeys	
	...
	public void WaitUntil(WebElement ele, int timeout)
	{
		try
		{
			WebDriverWait wait= new WebDriverWait(driver, Duration.ofSeconds(timeout));
		...
		{
			System.out.println("problem in waitUntil");
			ex.printStackTrace();
		}
	}
...
//scroll to the top of the page
	...
	public void handleAlert() {
	    try {
	        ...
	        // Perform any necessary action (e.g., accept, dismiss)
	        alert.accept(); // To accept the alert
	         alert.dismiss(); // To dismiss the alert

	        // Optionally, you can also send keys to the alert (if it's a prompt)
